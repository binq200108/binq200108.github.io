(function () {
  ...
  (function initLightbox() {
    ...
    // Default to stable open on desktop to avoid visible flash/flicker.
    var stableOpenMode = flipMotionConfig.stableOpenMode !== false;
    ...
    function shouldUseLiteMotion() {
      ...
      if (coarseMatcher && coarseMatcher.matches) return true;
    ...
    function openLightbox() {
      ...
      lightbox.style.opacity = overlayOpenDuration > 0 ? '0' : '1';
      if (!canFlipOpen) {
        setMainImageOpacity(1, 0);
      } else {
    ...
    function closeLightbox() {
      ...
      var r = ((rotation % 360) + 360) % 360;
      var disableFlipOnCoarse = !!(coarseMatcher && coarseMatcher.matches);
      var canFlipBack = !stableOpenMode && isUsableRect(thumbRect) && !isZoomed && r === 0 && !disableFlipOnCoarse && !lightboxLiteMotion;
